  ...
  return (
    ...
    >
      <div className={cn("flex items-center flex-col")}>
        ...
        <div
          className={cn(
            "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[repeat(auto-fit,minmax(200px,1fr))] gap-4 w-full",
            className
          )}
        >
          {children}
...
export const PricingCard = ({
  ...
  return (
    <div
      className={cn(
        "border rounded-xs bg-background w-full h-full pt-6 text-foreground",
        recommendedText &&
          !uniform &&
